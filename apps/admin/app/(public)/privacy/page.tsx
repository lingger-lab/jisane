      ...
      <div className="flex flex-col gap-8 text-sm leading-relaxed text-text-muted">
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            회사는 이에 대해 지체 없이 조치합니다. 회원 탈퇴는 각 회원 유형의 마이페이지(전문가회원은 전문가회원
            정보 화면)에서 직접 할 수 있으며, 탈퇴 시 개인식별정보는 즉시 익명화됩니다. 다만 관계 법령에 따라
            보존 의무가 있는 거래·결제 기록은 아래 보유기간 동안 보존된 뒤 파기됩니다.
          </p>
        </section>
