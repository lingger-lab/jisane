      ...
      {aiSuggestion ? (
        <div className="rounded-xl border border-info/20 bg-info/5 p-4">
          ...
          <div className="mt-3">
            <button
              ...
              className="w-full rounded-lg bg-info-solid px-3 py-2 text-xs font-medium text-white hover:bg-info-solid/90"
            >
              AI 제안 적용
            </button>
          </div>
        ...
        <div className="rounded-xl border border-dashed border-info/30 p-4 text-center">
          ...
          <button
            ...
            className="mt-2 rounded-lg bg-info-solid px-4 py-2 text-xs font-medium text-white hover:bg-info-solid/90 disabled:opacity-50"
          >
      ...
      <form action={formAction} className="rounded-xl border border-border p-4">
        ...
        <div className="mb-4">
          ...
          <textarea
            id="comment"
            name="comment"
            placeholder="기업/시니어지식인에게 공개되는 평가입니다."
            rows={3}
